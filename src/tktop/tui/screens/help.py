...
HELP_TEXT = """\
 ...
 TOKEN FLOW
   Sparkline showing output tokens per turn over time.
   • ▁▁▁▁▁▁▁  Flat/low    — short, efficient responses
   • ▁▂▃▅▇█  Rising      — possible token explosion (drift alert will fire)
   • ▁█▁█▁█  Spiky       — mix of tool calls and explanations
   • ▁▁▁████  Late spike  — agent went verbose recently
